...
public class ApplicationEvent extends EventObject {
	...
	/**
	 * Marks the event as handled. After this method handles an ApplicationEvent, it may be useful
	 * to specify that it has been handled. This is usually used in conjunction with
	 * <code>getHandled()</code>. Set to <code>true</code> to designate that this event has been
	 ...
	 * corresponds to an AppleEvent that needs to act on a particular file, the ApplicationEvent
