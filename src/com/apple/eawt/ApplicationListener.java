...
public interface ApplicationListener extends EventListener {
	/**
	 * Called when the user selects the About item in the application menu. If <code>event</code> is
	 * not handled by setting <code>isHandled(true)</code>, a default About window consisting of the
	 * application's name and icon is displayed. To display a custom About window, designate the
	 * <code>event</code> as being handled and display the appropriate About window.
	 *
	 ...
	 * <code>isHandled(true)</code> for the <code>event</code>. To reject the quit, set
